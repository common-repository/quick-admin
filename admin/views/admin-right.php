<?php
/**
 * Right sidebar content of plugin pages.
 */
?>
<div class="meta-box-sortables">
    ...
    <div class="postbox">
        ...
        <div class="inside">
            ...
            <p><a href="http://wordpress.org/support/plugin/quick-admin" target="_blank">Visit our plugin support page</a></p>
        </div> <!-- .inside -->
...
<div class="meta-box-sortables">
    ...
    <div class="postbox">
        ...
        <div class="inside">
            ...
            <ul>
                <li><a href="http://wordpress.org/support/view/plugin-reviews/quick-admin" target="_blank">Review and rate this plugin on WordPress.org</a></li>
            </ul>
        </div> <!-- .inside -->
...
<div class="meta-box-sortables">
    <div class="postbox">
        ...
        <div class="inside">
            ...
            <p>
              <a href="http://wordpress.org/plugins/simple-register/" target="_blank">Simple Register</a>
            </p>
            <p>
